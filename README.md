...
- **스마트글래스를 이용한 매장 내 상품 인식 및 정보 조회 APP **
- 결과 : 한성대 2019 캡스톤디자인 우수상

#### ***한성대학교 공학경진대회 (7월 ~ 9월 27일)***
- **스마트글래스를 이용한 눈동자 움직임에 따른 특정 사물 제어**
- 결과 : 한성대 2019 공학경진대회 장려상

#### ***멀티미디어 추계학술대회  (10월 ~ 11월 16일)***
...
#### 스마트글래스를 이용한 매장 내 상품인식 및 상품 정보 알림 APP 구현
![시스템구성도2](readme_image/시스템구성도2.png)
...
### ■ 느낀점
- 지나고 나서 생각해보면, 하나의 프로젝트로 캡스톤 디자인, 공학경진대회, 멀티미디어 학회 까지.. 한 프로젝트를 1년여간 시간을 투자하고, 유지보수하고, 점진적으로 더 나아간다는게 정말 쉬운 일은 아니였던 것 같다. 그래도 단계단계 밟아가며 완성할 때마다 정말 느꼇던 만족감과 성취감은 이루 말할 수 없었다. 
...
***사진 속 출연진들은 같이 프로젝트에 참여한 멤버로 모두 각 분야에서 한가닥 하고자 하는 개발자들입니다***
